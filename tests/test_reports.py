...
def test_payment_summary_counts_by_status(conn):
    plan_id = payments.create_plan(conn, "Monthly", 1500.0, 30)
    paid_id = members.create_member(conn, {"first_name": "Paid", "mobile": "111", "plan_id": plan_id})
    overdue_id = members.create_member(conn, {"first_name": "Overdue", "mobile": "222", "plan_id": plan_id})
    members.create_member(conn, {"first_name": "NoPay", "mobile": "333", "plan_id": plan_id})
    user_id = auth.create_user(conn, "staffer", "pw12345", "Staff One", "staff")
